...
if __name__=="__main__":
    ...
    # Para descifrad:
    # 1. openssl pkeyutl -decrypt -inkey private_key.pem -in sergi.guimera_RSA_RW.enc -out AES_key.txt
    # 2. openssl enc -d -aes-128-cbc -pbkdf2 -kfile AES_key.txt -in sergi.guimera_AES_RW.enc -out decrypted_file.png
